...
class Triangle(val p1: Point, val p2: Point, val p3: Point, override var transform: Matrix = Matrix.eye(4), override var material: Material = SolidColor(), override var parent: Shape? = null): Shape {
  var e1: Vector = p2 - p1
  var e2: Vector = p3 - p1
